...
frappe.ui.form.on("Customer Service Package", {
    ...
    async update_total_price(frm) {
        ...
        (frm.doc.package_services || []).forEach((row) => {
            ...
            net_total_package_price += amount;
        });
    ...
    update_total_qty(frm) {
        ...
        frm.set_value("net_total_qty", total_package_qty + total_extra_qty);
        frm.refresh_field("net_total_qty");
    },
});
